...
* Added additional initializer to init class (tb client) with a *token* and *refreshToken* (instead of *username* and *password*). Refer to <doc:Usage> for further details.
