...
- Take `ServerSettings.sample.json`, enter your credentials and save it as `ServerSettings.json` in the same directory. The file reside in `Tests/TBRESTClientLibTests/Resources/`.
