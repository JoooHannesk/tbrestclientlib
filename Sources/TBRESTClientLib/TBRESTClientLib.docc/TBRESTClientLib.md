...
When documenting my code I tried to refere to the official ThingsBoard Documentation nomenclature as well as official API documentation as close as possible. It may did not work out all the time.
